...
public class SettingsProviderClass implements SettingsProvider, Logged {
    private final boolean isDarkTheme;

    public SettingsProviderClass(boolean isDarkTheme) {
    ...
    public TextStyle getDefaultStyle() {
        if (this.isDarkTheme)
            return new TextStyle(TerminalColor.WHITE, TerminalColor.rgb(0, 69, 92));
        else
            return new TextStyle(TerminalColor.BLACK, TerminalColor.rgb(202, 240, 248));
    }
