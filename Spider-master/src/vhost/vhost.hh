...
namespace http
{
    ...
    public:
         ...
         */
        explicit VHost(const VHostConfig &config)
            : conf_(config)
        {}
        ...
        /**
         * \brief Get vhost configuration of the VHost.
         *
         * \return conf_.
         */
        ...
        /**
         * \brief Verify if the VHost is certified.
         *
         */
        void certified();

        /**
         * \brief Get the ssl_context of the vhost.
         *
         * \return ssl_ctx_
         */
        std::unique_ptr<SSL_CTX, decltype(SSL_CTX_free) *> &ssl_ctx_get()
        {
            return ssl_ctx_;
        }
