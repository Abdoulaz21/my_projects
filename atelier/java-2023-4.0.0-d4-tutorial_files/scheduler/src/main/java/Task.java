...
public interface Task<RETURN_TYPE> {
    ...
    /**
     * Static initializer allowing to create a task instance with the given {@link Supplier}.
     *
     * @param actionSupplier The actual action to execute.
     * @param <RETURN_TYPE>  The excepted return type, inferred by the call chain.
     ...
     *
     * @return The build {@link CompletableFuture}.
     */
    ...
    /**
     * Specify a function providing a recovery value to use if the task fails.
     *
