 ...
 * <p>
 * We don't care about infinite, unordered or parallel stream in this implementations, consider all streams this
 * interface interacts with to be finite, ordered and sequential.
 *
...
public interface ExtendedStream<ELEMENT_TYPE> extends Stream<ELEMENT_TYPE> {
    ...
    /**
     * Creates a stream of pairs of the content of the stream and values produces by an other stream.
     * Once any of the two streams is close, the produced stream is complete, regardless of potential values remaining
     * in the other stream.
     *
     * @param supplier          the value supplier.
     * @param <ASSOCIATED_TYPE> the type of associated values.
     ...
     */
    Object join(final String delimiter);
    ...
    /**
     * An utility class representing a pair.
     *
